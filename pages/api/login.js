...
// Настройки безопасности - в реальном приложении храните их в .env
const ADMIN_USERNAME = 'admin'; // Замените на свое имя пользователя
const ADMIN_PASSWORD_HASH = '$2a$10$XFE2VJbwOJ.kFP5T9pTz6OQMeABHWC9XRAaK9ASRpaRGweSfgMOTa'; // Хеш от 'password123'
